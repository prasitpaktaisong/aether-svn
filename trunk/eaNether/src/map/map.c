...
//=============================================================
// Version: 7360
// Instalation Date: 02/02/2011 04:44:47
...
int map_quit(struct map_session_data *sd)
{
	...
	if( sd->state.bg_id ) sd->status.bgstats.deserter++;
