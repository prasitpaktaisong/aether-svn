...
int intif_parse_Mail_inboxreceived(int fd)
{
	...
	else if( battle_config.mail_display_mode == 0 || (sd->mail.inbox.unchecked > 0 && battle_config.mail_display_mode & 1) || (sd->mail.inbox.unread > 0 && battle_config.mail_display_mode & 2) )
	{
		char output[128];
